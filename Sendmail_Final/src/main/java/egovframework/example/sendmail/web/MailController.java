...
public class MailController {
	...
	final static String portNum = "25";
...
//		System.out.println("sendmail의 login 호출");  
	...
	public String login(@RequestParam("user_id") String user_id, @RequestParam("password") String password,
			HttpServletRequest request, RedirectAttributes r, ModelMap model) throws Exception {
...
//		System.out.println("user_name:" + user_name);
		...
		if (user_name != null && !"".equals(user_name)) {
			...
			// 이때 MailVO에서 userName을 변수로 선언하고 getter와 setter를 만들어줘야 정상작동한다. 파라미터로 가는데도 VO가
			// 필요한듯?
		} else {
...
//		return "board/list";
	...
	public String wholebox(@ModelAttribute("mailVO") MailVO mailVO, ModelMap model) throws Exception {
	...
	public String inbox(@ModelAttribute("mailVO") MailVO mailVO, @RequestParam("userName") String userName,
...
//		System.out.println("inbox.do에서 userName:" + userName);
	...
	public String outbox(@ModelAttribute("mailVO") MailVO mailVO, ModelMap model) throws Exception {
	...
	public String writePage(@ModelAttribute("mailVO") MailVO mailVO, ModelMap model) throws Exception {
		return "sendmail/write";
	}

	@RequestMapping(value = "/write.do")
	public String write(HttpServletRequest request, HttpServletResponse response,
			@RequestParam("receiverAddress") String receiverAddress, @RequestParam("title") String title,
	...
	public static void connectSMTP() throws UnknownHostException {
		...
		prop.put("mail.smtp.host", hostIp);
		prop.put("mail.smtp.starttls.enable", "true");
		prop.put("mail.smtp.port", portNum);
