...
//	private SampleDAO sampleDAO;
	...
	public void updateUser(SendMailVO vo) throws Exception {
		sendMailDAO.updateUser(vo);
	}

	public SendMailVO selectUser(SendMailVO vo) throws Exception {
		SendMailVO resultVO = sendMailDAO.selectUser(vo);
		if (resultVO == null) {
			resultVO = new SendMailVO();
		}
		return resultVO;
	}
