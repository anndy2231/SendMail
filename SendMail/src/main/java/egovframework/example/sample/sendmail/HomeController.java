...
public class HomeController {
	...
	public String registerAction(@ModelAttribute("sendMailVO") SendMailVO sendMailVO, HttpServletRequest request,
			ModelMap model) throws Exception {
...
//		request.getParameter("password");
	...
	public String sent(@ModelAttribute("sendMailVO") SendMailVO sendMailVO, HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
