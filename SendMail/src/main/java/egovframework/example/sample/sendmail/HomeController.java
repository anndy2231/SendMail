...
public class HomeController {
	...
	public String update(@ModelAttribute("sendMailVO") SendMailVO sendMailVO, HttpServletRequest request, ModelMap model) throws Exception {
		String name = sendMailService.selectUser(sendMailVO);
	...
	public String updateAction(@ModelAttribute("sendMailVO") SendMailVO sendMailVO, ModelMap model) throws Exception {
