...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="write.do" data-target="#collapsePages"
              ...
              <li class="nav-item">
                <a class="nav-link" href="sent.do" data-target="#collapsePages"
                    aria-expanded="true" aria-controls="collapsePages">
                    <i class="fas fa-fw fa-table"></i>
                    <span>보낸메일함</span></a>
            </li>
              ...
              <li class="nav-item">
                <a class="nav-link" href="received.do" data-target="#collapsePages"
                    aria-expanded="true" aria-controls="collapsePages">
                    <i class="fas fa-fw fa-table"></i>
                    <span>받은메일함</span></a>
         	   </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="trashCan.do" data-target="#collapsePages"
                    aria-expanded="true" aria-controls="collapsePages">
                    <i class="fas fa-fw fa-table"></i>
                    <span>휴지통</span>
                </a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
   					...
   					<div >
   						<button class="btn btn-primary btn-user btn-block" style="width:100px" onclick="location.href='/SendMail/register.do'">회원가입</button>
   						<button class="btn btn-primary btn-user btn-block" style="width:100px" onclick="location.href='/SendMail/login.do'">로그인</button>
   						<button class="btn btn-primary btn-user btn-block" style="width:100px" onclick="out();")>로그아웃</button>
   						<button class="btn btn-primary btn-user btn-block" style="width:100px" onclick="location.href='/SendMail/main.do'">메인으로</button>
   					</div>
